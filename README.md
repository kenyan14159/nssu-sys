...
- **決済管理**: 銀行振込確認（振込明細画像アップロード）、**領収書自動発行（PDF）**
- **駐車場申請**: 大型バス・中型バス・乗用車の駐車場希望申請、**割当確認・駐車許可証ダウンロード**
- **お知らせ機能**: 競技会に関する重要なお知らせ・ニュースの閲覧

### 管理者向け機能
- **入金確認**: 振込明細画像の確認・承認、エントリー確定、**トラブル用強制承認機能**
- **自動番組編成**: 申告タイムに基づく組分け・腰ナンバー割り当て、NCG（NITTAI CHALLENGE GAMES）対応、**上位組と一般組の自動スライド**
- **ゼッケン番号採番**: 性別・NCG種目別の自動採番ルール適用
- **帳票出力**: スタートリストCSV、点呼表PDF、プログラム原稿PDF、結果記録用紙PDF、駐車許可証PDF、**全データバックアップCSV/PDF**
- **当日点呼**: 組ごとの選手点呼管理
...
詳細な仕様や運用方法については、以下のドキュメントを参照してください。

- [システム完全ガイド](file:///Users/shotaro/Web%E3%82%B5%E3%82%A4%E3%83%88/nit-sys/docs/%E3%82%B7%E3%82%B9%E3%83%86%E3%83%A0%E5%AE%8C%E5%85%A8%E3%82%AC%E3%82%A4%E3%83%89.md) - 全機能の詳細解説・設定手順
- [データ管理ガイド](file:///Users/shotaro/Web%E3%82%B5%E3%82%A4%E3%83%88/nit-sys/docs/%E3%83%87%E3%83%BC%E3%82%BF%E7%AE%A1%E7%90%86%E3%82%AC%E3%82%A4%E3%83%89.md) - インポート・エクスポートの仕様
- [APIドキュメント](file:///Users/shotaro/Web%E3%82%B5%E3%82%A4%E3%83%88/nit-sys/docs/API.md) - 外部連携用API仕様

## 開発進捗

現在の実装完了率は **約94%** です（2025年12月現在）。
詳細は [TODOリスト](file:///Users/shotaro/Web%E3%82%B5%E3%82%A4%E3%83%88/nit-sys/docs/TODO.md) を確認してください。
